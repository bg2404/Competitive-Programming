...
contract("AuctionContract", function (accounts) {
    ...
    ***********/
        return auctionInstance
            .bid(0, 6, { from: accounts[1] }) /*<CODE HERE>*/
            .then(function (result) {
                /*
    ...
    ***********/
        return auctionInstance
            .revealWinners({ from: accounts[1] }) /*<CODE HERE>*/
    ...
    ***********/
        return auctionInstance
            .register({ from: accounts[2] }) /*<CODE HERE>*/
            .then(function (result) {
                /**********
      TASK 8: Call register function from account 3
      ***********/
                return auctionInstance.register({
                    from: accounts[3],
                }); /*<CODE HERE>*/
            })
            .then(function () {
      ...
      ***********/
                return auctionInstance.bid(0, 5, {
                    from: accounts[2],
                }); /*<CODE HERE>*/
            })
            .then(function () {
      ...
      ***********/
                return auctionInstance.bid(1, 5, {
                    from: accounts[3],
                }); /*<CODE HERE>*/
            })
            .then(function () {
      ...
      ***********/
                return auctionInstance.bid(2, 5, {
                    from: accounts[4],
                }); /*<CODE HERE>*/
            })
            .then(function () {

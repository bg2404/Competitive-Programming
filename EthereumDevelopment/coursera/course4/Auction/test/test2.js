...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return auctionInstance.bid(0, 6)/*<CODE HERE>*/
    .then(function (result) {
      /*
  ...
  it("Should set winners", function() {
    ...
    ***********/
    return auctionInstance.register({ from: accounts[2] }) /*<CODE HERE>*/
      ...
      ***********/
            return auctionInstance.winners({ from: accounts[0] })[0]; /*<CODE HERE>*/
        })
        .then(function (result) {
            /**********
      ...
      ***********/
            return auctionInstance.winners({ from: accounts[0] })[1]; /*<CODE HERE>*/
        })
        .then(function (result) {
            /**********
      ...
      ***********/
            return auctionInstance.winners({ from: accounts[0] })[2]; /*<CODE HERE>*/
        })
        .then(function (result) {
            /**********
